...
ER_RTL_EXPORT void store_current_exception(lua_State* l, char const* what)
{
...
ER_RTL_EXPORT stored_exception* test_stored_exception(lua_State* l)
{
...
ER_RTL_EXPORT bool push_stored_exceptions_what(lua_State* l)
{
...
ER_RTL_EXPORT std::exception_ptr extract_stored_exception(lua_State* l)
{
    stored_exception* stored = test_stored_exception(l);
    if (stored != nullptr)
    {
