...
ER_RTL_EXPORT std::uint32_t registerPersistentProperty(const Er::PropertyInfo* info)
{
    ...
    if (it != r.persistentProps.end())
    {
        ...
        ErLogWarning2(Er::Log::get(), "Property already registered: {} [{}] of type {}", info->name(), info->readableName(), Er::propertyTypeToString(info->type()));
    ...
    ErLogDebug2(Er::Log::get(), "Property {} registered: {} [{}] of type {}", id, info->name(), info->readableName(), Er::propertyTypeToString(info->type()));
...
ER_RTL_EXPORT const Er::PropertyInfo* allocateTransientProperty(Er::PropertyType type, const std::string& name, const std::string& readableName)
{
    ...
    if (it != r.persistentProps.end())
    {
        ...
        ErLogDebug2(Er::Log::get(), "Transient property mapped to persistent property {} [{}] of type {}", name, readableName, Er::propertyTypeToString(type));
        return it->second;
    }
    ...
    if (it2 != r.transientProps.end())
    {
        ...
        ErLogDebug2(Er::Log::get(), "Transient property found: {} [{}] of type {}", name, readableName, Er::propertyTypeToString(type));
    ...
    ErLogDebug2(Er::Log::get(), "Transient property registered: {} [{}] of type {}", name, readableName, Er::propertyTypeToString(type));
