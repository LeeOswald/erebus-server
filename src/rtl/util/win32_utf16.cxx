...
ER_RTL_EXPORT std::string utf16To8bit(int cp, const wchar_t* s, std::optional<size_t> length)
{
    std::string out;
...
ER_RTL_EXPORT std::wstring utf8ToUtf16(const std::string& s)
{
    std::wstring out;
...
ER_RTL_EXPORT std::wstring localToUtf16(const std::string& s)
{
    std::wstring out;
