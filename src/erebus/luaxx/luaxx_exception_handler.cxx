...
EREBUS_EXPORT void store_current_exception(lua_State* l, char const* what)
{
...
EREBUS_EXPORT stored_exception* test_stored_exception(lua_State* l)
{
...
EREBUS_EXPORT bool push_stored_exceptions_what(lua_State* l)
{
...
EREBUS_EXPORT std::exception_ptr extract_stored_exception(lua_State* l) 
{
    stored_exception* stored = test_stored_exception(l);
    if (stored != nullptr)
    {
