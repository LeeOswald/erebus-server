...
public:
    ...
    Hash digest() noexcept;

    static std::string str(const Hash & digest);
...
private:
    ...
    static uint32_t choose(uint32_t e, uint32_t f, uint32_t g) noexcept;
    static uint32_t majority(uint32_t a, uint32_t b, uint32_t c) noexcept;
    static uint32_t sig0(uint32_t x) noexcept;
    static uint32_t sig1(uint32_t x) noexcept;
    void transform() noexcept;
    void pad() noexcept;
    void revert(Hash& hash) noexcept;
};
