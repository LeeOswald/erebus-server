...
public:
    ObjFun(lua_State* l, const std::string& name, Ret(*fun)(Args...))
        : ObjFun(l, name, _fun_type{fun}) 
    {}

    ObjFun(lua_State* l, const std::string& name, _fun_type fun) 
        : _fun(fun) 
    {
...
public:
    ObjFun(lua_State* l, const std::string& name, void(*fun)(Args...))
        : ObjFun(l, name, _fun_type{fun}) 
    {}
