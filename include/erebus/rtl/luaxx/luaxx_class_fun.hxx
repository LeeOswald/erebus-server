...
#include <erebus/rtl/luaxx/luaxx_base_fun.hxx>
...
public:
    ClassFun(lua_State* l, const std::string& name, const std::string& metatable_name, Ret(*fun)(Args...))
        : ClassFun(l, name, _fun_type{fun}) 
    {}

    ClassFun(lua_State* l, const std::string& name, const std::string& metatable_name, _fun_type fun)
        : _fun(fun)
        , _name(name)
...
public:
    ClassFun(lua_State* l, const std::string& name, const std::string& metatable_name, void(*fun)(Args...))
